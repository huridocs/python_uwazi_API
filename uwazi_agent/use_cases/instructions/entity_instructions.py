ENTITY_INSTRUCTIONS = (
    ...
    "Call this at most ONCE per template with a reasonable limit (e.g. 5-30). "
    "If you need to check whether any entities exist, use limit=1 — do not call "
    "it twice with different limits.\n"
    ...
    "(make private) entities by ``shared_id``. Use ``get_publish_status`` "
    "first to drop ids already in the target state, and chunk at 50 ids per "
